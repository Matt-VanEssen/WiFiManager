...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#e6d395;color:#000;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #e6d395}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#e6d395;text-decoration:underline}"
// quality icons
...
// msg callouts
".msg{padding:20px;margin:20px 0;border:1px solid #eee;border-left-width:5px;border-left-color:#777}.msg h4{margin-top:0;margin-bottom:5px}.msg.P{border-left-color:#e6d395}.msg.P h4{color:#e6d395}.msg.D{border-left-color:#dc3630}.msg.D h4{color:#dc3630}.msg.S{border-left-color: #5cb85c}.msg.S h4{color: #5cb85c}"
// lists
...
#ifdef ESP32
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Welcome to WiFi Setup</h3><hr><dl>";
...
const char S_brand[]              PROGMEM = "OVA Inc.";
